...
I assume that anyone who's in deep enough to want to install this has a preferred Vim or Neovim plugin manager, so just install this repo with that, and it should be good to go.
